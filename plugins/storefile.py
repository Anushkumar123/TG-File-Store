...
async def storefile(c, m):
    ...
    # creating urls
    bot = await c.get_me()
    url = f"https://t.me/Tamilmovieshd123_bot?start={m.chat.id}_{m.message_id}" if not DB_CHANNEL_ID else f"https://t.me/Tamilmovieshd123_bot?start={m.chat.id}_{msg.message_id}"
